/**
 * Обновление комнаты 601 по актуальному бланку (6 этаж).
 *
 * 601А: Бономо Софи (2-2), Лазук Дарья (3-4), Пусовская Ульяна (3-4)
 * 601Б: Белова Софья (3-9), Малевич Виолетта (3-9)
 *
 * Выбывают: Дейнеко Яна, Вазюра Анна, Стельмах Карина.
 */
...
const KEEP_OR_ADD: Person[] = [
  { room: '601А', last: 'Бономо', first: 'Софи', course: 2, groupNo: 2 },
  { room: '601А', last: 'Лазук', first: 'Дарья', middle: 'Геннадьевна', course: 3, groupNo: 4 },
  { room: '601А', last: 'Пусовская', first: 'Ульяна', middle: 'Андреевна', course: 3, groupNo: 4 },
  { room: '601Б', last: 'Белова', first: 'Софья', middle: 'Александровна', course: 3, groupNo: 9 },
  { room: '601Б', last: 'Малевич', first: 'Виолетта', middle: 'Андреевна', course: 3, groupNo: 9 },
];

const MOVE_OUT: Array<{ last: string; first: string }> = [
  { last: 'Дейнеко', first: 'Яна' },
  { last: 'Вазюра', first: 'Анна' },
  { last: 'Стельмах', first: 'Карина' },
];
...
await withTransaction(db, async (client) => {
  ...
  await materializeVersion(client, floor.id, {
    source: 'manual',
    note: 'Обновление бланка комнаты 601',
    force: true,
  });
});
